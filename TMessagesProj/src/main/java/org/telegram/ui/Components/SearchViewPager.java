...
public class SearchViewPager extends ViewPagerFixed implements FilteredSearchView.UiCallback, NotificationCenter.NotificationCenterDelegate {
    ...
    private void showActionMode(boolean show) {
        ...
        if (show && !parent.getActionBar().actionModeIsExist(actionModeTag)) {
            ...
            gotoItem = actionMode.addItemWithWidth(gotoItemId, R.drawable.msg_message, AndroidUtilities.dp(54), getString("AccDescrGoToMessage", R.string.AccDescrGoToMessage));
            forwardNoQuoteItem = actionMode.addItemWithWidth(forwardNoQuoteItemId, R.drawable.msg_forward, AndroidUtilities.dp(54), getString("NoQuoteForward", R.string.NoQuoteForward));
            forwardItem = actionMode.addItemWithWidth(forwardItemId, ConfigManager.getBooleanOrFalse(Defines.showNoQuoteForward) ? R.drawable.msg_noquote_forward :
                ...
                AndroidUtilities.dp(54), getString("Forward", R.string.Forward));
            ...
            deleteItem = actionMode.addItemWithWidth(deleteItemId, R.drawable.msg_delete, AndroidUtilities.dp(54), getString("Delete", R.string.Delete));
        }
